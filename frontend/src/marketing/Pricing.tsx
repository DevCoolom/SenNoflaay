...
const Pricing: React.FC = () => {
  const tiers = [
    ...
    },
    {
      name: 'Pro',
      price: '€7',
      desc: 'Everything a growing association needs to run smoothly.',
      features: [
        'Up to 200 members',
        'Full financial suite',
        'Task management',
    ...
    },
    {
      name: 'Pro Max',
      price: '€20',
      desc: 'Advanced features for serious associations and non-profits.',
      popular: true,
      features: [
        'Everything in Pro',
        'Unlimited members',
    ...
    },
    {
      name: 'Enterprise',
      price: '€49',
      desc: 'For large organizations needing scale, security, and full control.',
      features: [
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {tiers.map((tier, i) => (
              <motion.div
                ...
                className={`relative p-10 rounded-[3rem] border ${tier.popular
                    ? 'border-brand-600 bg-white shadow-2xl shadow-brand-100 ring-4 ring-brand-50'
                    : 'border-slate-100 bg-white'
                  }`}
              >
                {tier.popular && (
                  <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-brand-600 text-white px-6 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-xl whitespace-nowrap">
                    Most Popular
                  </div>
                )}
                ...
                <Link
                  ...
                  className={`block w-full py-5 rounded-2xl font-bold text-xs uppercase tracking-widest text-center transition-all ${tier.popular
          ...
          <div className="mt-20 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left max-w-4xl mx-auto">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm leading-relaxed">Our Free plan is free forever for small organizations. For larger non-profits, please contact our support team for specialized pricing.</p>
              </div>
              <div>
                <h4 className="font-bold text-slate-900 mb-4">What payment methods do you accept?</h4>
                <p className="text-slate-500 text-sm leading-relaxed">We accept all major credit cards and SEPA bank transfers for European customers.</p>
              </div>
              <div>
                <h4 className="font-bold text-slate-900 mb-4">Is there a free trial?</h4>
                <p className="text-slate-500 text-sm leading-relaxed">All paid plans come with a 14-day free trial. No credit card required to start.</p>
              </div>
            </div>
          </div>
        </div>
